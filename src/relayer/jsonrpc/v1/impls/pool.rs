...
impl<P> Pool<P>
where
    P: 'static + crate::traits::PoolService<SignedRequest = crate::types::SignedRequest>,
{
    ...
    P: 'static + crate::traits::PoolService<SignedRequest = crate::types::SignedRequest>,
{
    ...
    fn all_requests(&self) -> Result<Vec<crate::types::RelayerRpcRequest>> {
        ...
        let requests = pool
            .all_requests()
            .iter()
            .map(|req| crate::types::RelayerRpcRequest::from(req.as_ref()))
            .collect();
        Ok(requests)
    }
    ...
    fn ready_requests(&self) -> Result<Vec<crate::types::RelayerRpcRequest>> {
        let requests: Vec<_> = self
            ...
            .ready_requests(
                None,
                crate::traits::PoolPendingSettings {
                    filter: None,
                    gas_limit: 0.into(),
                    relayer: None,
                },

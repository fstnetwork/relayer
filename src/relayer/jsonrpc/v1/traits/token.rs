...
build_rpc_trait! {
    pub trait TokenApi {
        ...
        fn send_token_transfer_request(&self, crate::types::RelayerRpcRequest) -> BoxFuture<H256>;

        #[rpc(name="token_sendTokenTransferRequests")]
        fn send_token_transfer_requests(&self, Vec<crate::types::RelayerRpcRequest>) -> BoxFuture<Vec<H256>>;

        #[rpc(name="token_supportedTokens")]
        fn supported_tokens(&self) -> Result<Vec<crate::types::RelayerRpcToken>>;
    }
}
